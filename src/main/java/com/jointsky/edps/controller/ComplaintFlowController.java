...
@Api(value = "环境举报投诉数据入口",description = "长天长大数据平台环境举报投诉与污染源监控数据分析API")
...
public class ComplaintFlowController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "month",value = "月份",required = true,dataType = "Date",paramType = "query",defaultValue = "2013-05-01")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "regionName",value = "省份名",required = true,dataType = "String",paramType = "query",defaultValue = "上海市"),
            @ApiImplicitParam(name = "startMonth",value = "起始月份",required = true,dataType = "Date",paramType = "query",defaultValue = "2013-05-01"),
            @ApiImplicitParam(name = "endMonth",value = "结束月份",required = true,dataType = "Date",paramType = "query",defaultValue = "2013-10-01")
    })
